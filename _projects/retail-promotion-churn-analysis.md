...
description: End-to-end retail analytics pipeline ingesting 2.6M transactions into BigQuery, transforming with dbt and GitHub Actions CI, and delivering a Power BI dashboard with a concrete budget reallocation recommendation based on promotion effectiveness and churn analysis.
